...
<html>
	...
	<body>
	  ...
	  <img 
        src=\"modelica://TAeZoSysPro/Information/HeatTransfer/Functions/FreeConvection/EQ_ground_ASHRAE.png\"
        width = \"600\" />

	  <p>
		The correlation is given for a Rayleigh number:
		  <ul>
		  <li> 10<sup>5</sup> < Ra < 10<sup>10</sup> for a upward-facing cooled plate (if dT < 0) </li>
		  <li> 1 < Ra < 10<sup>9</sup> for a upward-facing heated plate (if dT > 0) </li>
		  </ul>
	  </p>
