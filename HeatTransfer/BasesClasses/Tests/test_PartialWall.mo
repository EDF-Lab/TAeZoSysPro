...
model test_PartialWall
  TAeZoSysPro.HeatTransfer.BasesClasses.PartialWall partialWall2(A = 2,N = 5, T_start = 293.15, Th = 0.1, cp = 1000, d (displayUnit = "kg/m3") = 1, energyDynamics = TAeZoSysPro.HeatTransfer.Types.Dynamics.FixedInitial, k = 1) annotation(
  ...
  TAeZoSysPro.HeatTransfer.BasesClasses.PartialWall partialWall1( T_start = 293.15, Th = 1, cp = 1000, d (displayUnit = "kg/m3") = 1, energyDynamics = TAeZoSysPro.HeatTransfer.Types.Dynamics.FixedInitial, k = 1, mesh = TAeZoSysPro.HeatTransfer.Types.MeshGrid.biotAndGeometricalGrowth) annotation(
