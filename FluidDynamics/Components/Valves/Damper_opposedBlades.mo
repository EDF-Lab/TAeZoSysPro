...
annotation(
    Icon(graphics = {Ellipse(origin = {4, 16}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {0, 0}}, endAngle = 360), Line(origin = {-1, 20}, points = {{-13, 14}, {15, -16}}), Line(origin = {0.305084, -19.9999}, points = {{14, 14}, {-14, -14}}), Line(origin = {0.62712, -60}, points = {{-13, 14}, {15, -16}}), Line(origin = {0, 1}, points = {{0, 79}, {0, -81}}, pattern = LinePattern.Dot), Ellipse(origin = {4, 56}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {0, 0}}, endAngle = 360), Ellipse(origin = {4, -64}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {0, 0}}, endAngle = 360), Line(origin = {0, 60}, points = {{14, 14}, {-14, -14}}), Ellipse(origin = {4, -24}, fillPattern = FillPattern.Solid, extent = {{-8, 8}, {0, 0}}, endAngle = 360)}));
end Damper_opposedBlades;
