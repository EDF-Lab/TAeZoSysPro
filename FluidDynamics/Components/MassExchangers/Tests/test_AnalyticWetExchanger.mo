...
model test_AnalyticWetExchanger
  ...
  TAeZoSysPro.FluidDynamics.Components.MassExchangers.AnalyticWetExchanger analyticWetExchanger(redeclare
      package                                                                                                     MediumB = Medium_Liq, CrossSectionB = 1.82e-2, ExchangeSurface = 631.8, K_global = 25, hcv_A = 30, ksi_fixedA = 39.54, ksi_fixedB = 52.53) annotation (
    Placement(visible = true, transformation(origin = {-3.55271e-15, 3.55271e-15}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
  Modelica.Fluid.Sources.FixedBoundary Air_sink(redeclare package Medium =
        Modelica.Media.Air.MoistAir,                                                                    nPorts = 1)  annotation (
  ...
  Modelica.Fluid.Sources.MassFlowSource_T Air_source(redeclare package Medium =
        Modelica.Media.Air.MoistAir,                                                                         T = 273.15 + 35, X = {0.011482, 1 - 0.011482}, m_flow = 13.04, nPorts = 1) annotation (
