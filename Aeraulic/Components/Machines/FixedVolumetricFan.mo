...
model FixedVolumetricFan
  ...
  parameter Modelica.SIunits.VolumeFlowRate Qv_flow_fixed = 1.0 "isentropic efficiency";
  //
  ...
  Modelica.SIunits.VolumeFlowRate Qv_flow(start = Qv_flow_fixed, displayUnit = "m3/h");
